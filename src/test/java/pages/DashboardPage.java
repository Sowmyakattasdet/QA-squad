...
public class DashboardPage extends BasePage {
	...
	public boolean profile_name() {
		return wait.until(ExpectedConditions.visibilityOf(profilename))
				.isDisplayed();
	}

	public boolean profileicondisplay() {
		return wait.until(ExpectedConditions.visibilityOf(profileicon))
				.isDisplayed();
	}

	public boolean bellicondisplay() {
		return wait.until(ExpectedConditions.visibilityOf(bellicon))
				.isDisplayed();
	}
	...
	public boolean subtextdisplay() {
		...
		return wait.until(ExpectedConditions.visibilityOf(subtext))
				.isDisplayed();
	}
	...
	public boolean gradiantslider() {
		return wait.until(ExpectedConditions.visibilityOf(gradiant))
				.isDisplayed();
	}
	...
	public boolean healthplantxt() {
		return wait.until(ExpectedConditions.visibilityOf(healthplan))
				.isDisplayed();
	}
	...
	public boolean heartcondisplayl() {
		return wait.until(ExpectedConditions.visibilityOf(heartcond))
				.isDisplayed();
	}
	public boolean healthedit() {
		return wait.until(ExpectedConditions.visibilityOf(healthed))
				.isDisplayed();
	}
	public boolean nohealthissue() {
		...
		return wait.until(ExpectedConditions.visibilityOf(noissue))
				.isDisplayed();
	}
	public boolean uploadfiledyanamic() {
		return wait.until(ExpectedConditions.visibilityOf(uploaddynamic))
				.isDisplayed();
	}
	public String uploadbutton() {
		String text = wait.until(ExpectedConditions.visibilityOf(uploadbn))
				.getText();
		return text;
	}
	public boolean reporttex() {
		return wait.until(ExpectedConditions.visibilityOf(reporttxt))
				.isDisplayed();

	}
	public boolean btnenable() {
		return wait.until(ExpectedConditions.visibilityOf(uploadbn))
				.isEnabled();
	...
	public boolean todaydate() {
		return wait.until(ExpectedConditions.visibilityOf(todatd))
				.isDisplayed();

	}
	public boolean subscriptionplan() {
		return wait.until(ExpectedConditions.visibilityOf(subplan))
				.isDisplayed();
	...
	public boolean premiumbtn() {
		return wait.until(ExpectedConditions.visibilityOf(upgradebtn))
				.isDisplayed();
